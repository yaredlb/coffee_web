        ...
        <div className="container min-h-[550px] flex justify-center items-center py-12 sm:py-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col justify-center gap-6 sm:pt-0">
              ...
              >
                Our coffee is made from the finest Arabica beans, carefully
                selected and roasted to bring out the perfect balance of
                flavors. Our coffee is a blend of Arabica and Robusta beans,
                roasted to perfection to bring out the perfect balance of
                flavors.
              </p>
